...
assert.deepEqual(manifestsByKind,
  { buildings: 19, figures: 10, obstacles: 5, projectiles: 9, troops: 11, villagers: 11, wrecks: 19 },
  'expected manifests for 19 buildings (tournament resolved: plain cannon + plain mortar, no @-variant slots), 11 troops (plain golem + icegolem; ward/recursion/giant/sharpshooter deleted with their musket_ball projectile), 19 wrecks, 5 obstacles, 11 villagers, 10 figures and 9 projectiles');
assert.equal(manifestFiles.length, 84, 'the baked unit roster changed size');
