...
export const MILITARY_BUILDING_DEFINITIONS: BuildingDefinitionMap<MilitaryBuildingType> = {
    barracks: {
        ...
        maxCount: 1,
        color: 0xff3333,
        // maxLevel 10 since the 2026-07 pavisebearer/hawkeyeassassin deletion
        // shortened the 2-per-level ladder (19 troops → ornithopter capstone
        // at L10). Levels past the baked art reuse the nearest baked tier
        // automatically (BuildingRenderer level clamp + SpriteBank
