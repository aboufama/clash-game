...
export const TROOP_DEFINITIONS: Record<TroopType, TroopDef> = {
    ...
    davincitank: { id: 'davincitank', name: 'Da Vinci Tank', cost: 600, space: 30, desc: 'Mechanica flagship: Leonardo\'s armored war machine fires in every direction.', health: 8000, range: 4.0, damage: 160, speed: 0.0006, color: 0xb8956e, targetPriority: 'defense', attackDelay: 1800 },
    ...
    wallbreaker: { id: 'wallbreaker', name: 'Wall Breaker', cost: 100, space: 4, desc: 'Volatile summoned creature that races to walls and erupts.', health: 200, range: 0.5, damage: 800, speed: 0.004, color: 0xff6633, targetPriority: 'wall', wallDamageMultiplier: 3, splashRadius: 2.5, attackDelay: 500, detonateOnAttack: true },
