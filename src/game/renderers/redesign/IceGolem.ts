 ...
 *    then 12→0 easeOut 400 ms); torso/shoulders/head/arms drop, planted legs
 *    do not; fists raise early then plant exactly at s = 1 with a cold flash.
    ...
    for (const side of [-1, 1]) {
        ...
        parts.push({
            ...
            draw: () => {
                ...
                // slam impact frost around the planted fist
