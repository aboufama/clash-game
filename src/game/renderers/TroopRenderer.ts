...
import { drawDaVinciTank as drawDaVinciTankArt } from './redesign/DaVinciTank';
...
export class TroopRenderer {
    ...
    static drawDaVinciTank(graphics: Phaser.GameObjects.Graphics, isPlayer: boolean, isMoving: boolean, isDeactivated: boolean = false, facingAngle: number = 0, troopLevel: number = 1, time: number = 0, tankSpin01: number = 0) {
        drawDaVinciTankArt(graphics, isPlayer, isMoving, isDeactivated, facingAngle, troopLevel, time, tankSpin01);
    }
}
